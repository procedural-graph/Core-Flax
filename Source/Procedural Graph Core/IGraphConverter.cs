...
{
    /// <summary>
    /// Determines whether the specified actor can be converted into an <see cref="IGraphNode"/>.
    /// </summary>
    ...
    /// <summary>
    /// Converts the specified actor into an <see cref="IGraphNode"/>.
    /// </summary>
    /// <param name="actor">The actor to convert.</param>
    /// <param name="models">The deserialized <see cref="GraphModel"/> instances for this actor.</param>
    ...
    IGraphNode Convert(Actor actor, IEnumerable<GraphModel> models, CancellationToken stoppingToken);
}
