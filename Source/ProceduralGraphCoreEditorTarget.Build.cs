...
public class ProceduralGraphCoreEditorTarget : GameProjectEditorTarget
{
    ...
    {
        base.PreBuild();
        Exec("dotnet build \"..\\..\\Generic\\Generic.csproj\" -c Release -f net9.0 -o \"..\\Content\\Assemblies\\\" -p:GenerateDocumentationFile=true -p:DebugType=portable -p:GenerateDependencyFile=false -p:CopyLocalLockFileAssemblies=true");
    }
